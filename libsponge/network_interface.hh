...
class NetworkInterface {
  private:
    ...
    std::unordered_map<uint32_t, std::list<std::pair<InternetDatagram, Address>>> _pending_datagrams{};

    static constexpr size_t _arp_request_timeout = 30000;
    static constexpr size_t _arp_request_interval = 5000;
